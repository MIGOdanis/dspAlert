setTimeout(function(){
	var a = document.getElementById("big_banner");
	var cf_imgs_array = document.getElementById("big_banner").getElementsByTagName("img");
	...
	if(cf_imgs_array[0].src.indexOf("eland") > 0){
		...
		console.log(a.getElementsByTagName("img"));
	}
} , 600);
