 ...
 */
class ImpUrl extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('p, url, creat_time', 'required'),
			array('creat_time', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, p, url, creat_time', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return DspImp the static model class
	 */
